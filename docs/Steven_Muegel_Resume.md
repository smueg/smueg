...
Washington DC–Baltimore Area · [Email](mailto:muegelsj@d1-box.slmail.me?subject=RE:%20Your%20Résumé%20on%20GitHub%20%5Bsmueg%5D) · [LinkedIn](https://linkedin.com/in/smuegel) · [GitHub](/smueg)
...
Full-stack developer who ships code built to survive contact with real users — and real audits. 10 years building accessible, high-traffic web applications for federal and higher-ed clients, with the DevOps range to deploy and maintain them. Equally comfortable in JavaScript, Python/Django, PHP/Laravel, and Ruby on Rails as in the Bash scripts and CI/CD pipelines that ship them — with a track record of cutting manual overhead, hardening WCAG/Section 508 compliance, and integrating AI APIs (Claude, Gemini) into production systems.
