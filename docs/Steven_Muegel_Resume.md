...
Washington DC–Baltimore Area · [Email](mailto:muegels@protonmail.com) · [LinkedIn](https://linkedin.com/in/smuegel) · [GitHub](https://github.com/smueg)
...
Full-Stack Developer & DevOps Engineer with 10 years building and deploying accessible, high-traffic web applications for federal and higher-ed clients — code built to survive contact with real users and real audits. Cut manual deployment overhead 15% through Bash/CI-CD automation and grew user engagement 25% building full-stack features across Laravel, Django, and C#, while maintaining full WCAG/Section 508 accessibility compliance and passing federal Fortify security scans. Equally comfortable across JavaScript, Python, PHP, Ruby, and C#, and the Docker/Kubernetes CI/CD pipelines that ship them.
...
- Built full-stack features spanning Laravel PHP, Django Python, and C# — grew user engagement 25%, measured via Adobe Analytics and in-house reporting tools
- Refactored a legacy monolithic codebase into a modular API system, building the front-end in Angular and the back-end in C#
- Engineered REST/GraphQL API integrations with SQL Server to connect front-end and backend systems in real time
- Maintained the DevOps pipeline: containerized deployments with Docker, orchestrated workloads with Kubernetes, automated releases with Bash, and coordinated CI/CD through Jenkins and TFS/Azure DevOps for consistent Git-based delivery
...
- **NoSQL Data Stores**: Explored Redis and other NoSQL databases for caching and data-modeling experiments
- **Container Runtime Exploration**: Evaluated Podman as a rootless alternative to Docker for personal container workflows
- **Microservices Architecture**: Designed and ran multi-container microservices setups using Docker and Docker Compose for personal projects
- **Secure Tunnel Infrastructure**: Architected a self-hosted alternative to Cloudflare Tunnel using Pangolin, Traefik, and WireGuard, designed for full-path encryption rather than endpoint-only security
...
[![Email](https://img.shields.io/badge/Email-6D4AFF?style=for-the-badge&logo=protonmail&logoColor=white)](ailto:muegels@protonmail.com?subject=Re:%20Your%20GitHub%20R%C3%A9sum%C3%A9)

<br>

**GitHub**

[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/smueg)

<br>

**LinkedIn**

[![LinkedIn](https://custom-icon-badges.demolab.com/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin-white&logoColor=white)](https://linkedin.com/in/smuegel)
